    ...
    <div className="bg-base-200 pt-10 dark:bg-black dark:text-white">
      <div className="lg:mx-20 h-full my-12 pb-10">
        <div className="flex justify-center gap-5 items-center">
          ...
          <ReactToPrint
            trigger={() => (
              <button className="btn  btn-warning text-center btn-outline hover:bg-amber-400">
                DownLoad PDF
              </button>
            )}
        ...
        <div ref={text} className="p-2">
          ...
          <div className="mt-5">
            ...
            <p className="text-lg mt-3">
              ...
              and multi-page, and hybrid web applications.Express.js is a
          ...
          <div className="mt-5">
            ...
            <p className="text-lg mt-3">
              <b>Ans:</b>A custom hook is a special JavaScript function whose
              name starts with ‘use’ and can be used to call other hooks.Custom
              React JS hooks offer reusability as when a custom hook is created,
